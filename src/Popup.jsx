...
export default function Popup({ isOpen, setIsOpen, formData, setFormInput, isDarkMode }){
  ...
  return (
    ...
    <div className="bg-white dark:bg-slate-900 dark:text-white flex-col p-4 rounded-lg" onClick={e =>  e.stopPropagation()}>
      ...
      return(
        <div className="flex sapce-x-6 justify-center items-center phone:w-80">
          ...
          <div className="flex flex-col space-y-1">
              <h1 className="text-red-500 font-bold">Please enter your information</h1>
